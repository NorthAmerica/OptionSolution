(function() {
  ...
  $(function() {
    ...
    $('#switch-ONOFFMode,#switch-HandSwitch,#switch-Checking').bootstrapSwitch();//个别checkbox设置为bootstrapSwitch
    //全局设置$("input[type=\"checkbox\"], input[type=\"radio\"]").not("[data-switch-no-init]").bootstrapSwitch();
